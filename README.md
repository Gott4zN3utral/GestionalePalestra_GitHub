...
## Note per il portfolio

Se pubblichi questo progetto su GitHub, ti consiglio di aggiungere:

- uno screenshot della dashboard
- uno screenshot della sezione iscritti
- una descrizione breve del problema risolto
- un elenco delle tecnologie usate

## Licenza

Puoi aggiungere una licenza se vuoi rendere il repository piu completo per il portfolio. Se non specifichi nulla, il progetto resta senza licenza esplicita.
